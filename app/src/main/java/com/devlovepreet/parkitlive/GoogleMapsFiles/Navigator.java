package com.devlovepreet.parkitlive.GoogleMapsFiles;
...
public class Navigator {
    ...
    private int pathBorderColor = Color.GREEN;
    ...
    private Polyline showBorderPath(Route route, int color){
        return map.addPolyline(new PolylineOptions().addAll(route.getPath()).color(color).width(pathWidth+8));
    }
